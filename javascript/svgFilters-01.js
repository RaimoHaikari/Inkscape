function Filters() {
	...
	var tgElements;				// SVG-kuvat, joilla suodattimia demotaan
...
tgElements = d3.map();
tgElements.set("Eka", "img/basic.svg");	
tgElements.set("Toka", "img/pallo.svg");
tgElements.set("Kolmas", "img/mutteri.svg");
   ...
   /*
    ...
    var changeImages = function(){
		...
		var tmp = d3.selectAll("div.tabcontent div.card")
			.data([]);
   ...
   /*
    ...
    var setupGroup = function(g, selection){
    	...
    	for(var i = 0; i < g.children.length; i++){
			...
			var sImage = ModelImage()
				...
				.height(200)
				.filter(g.children[i])
				.filename(tgElements.get(activeLayer));
    ...
    var _setupGroup = function(g, selection){
...
console.log(this.id)
     ...
     */
    var _setupOriginalImage = function(){
